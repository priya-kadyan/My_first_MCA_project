...
public class WeatherApp
{
    ...
    private static String apiKeyOpenWeather = "************";
    
    //authentication key for tom tom api
    private static String apiKeyTomTom = "*************";
    ...
    private static String getReverseGeoEncoding(String latitude ,String longitude){
        ...
        //response format : [{"name":"City of London","local_names":{"ar":"????? ????","ascii":"City of London","bg":"????","ca":"La City","de":"London City","el":"S?t? t?? ???d????","en":"City of London","fa":"???? ????","feature_name":"City of London","fi":"Lontoon City","fr":"Cité de Londres","gl":"Cidade de Londres","he":"????? ?? ??????","hi":"???? ??? ????","id":"Kota London","it":"Londra","ja":"???·??·????","la":"Civitas Londinium","lt":"Londono Sitis","pt":"Cidade de Londres","ru":"????","sr":"????","th":"?????????","tr":"Londra Sehri","vi":"Thành ph? Luân Ðôn","zu":"Idolobha weLondon"},"lat":51.5128,"lon":-0.0918,"country":"GB"}]
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<stops.size();){
		    ...
		    i = i>stops.size() ? stops.size()-1 : i!=stops.size()-1 ? i + (stops.size()/20 + 1) : i;
		}
